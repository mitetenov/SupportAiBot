...
class OpenAiClientTest {
    ...
    void shouldBuildConversationWithImage() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<Map<String, Object>> conv = (List<Map<String, Object>>) method.invoke(
                client, "What is this?", 123L, null, "base64imagestring", "image/png");
        ...
        assertEquals("What is this?", textPart.get("text"));

        @SuppressWarnings("unchecked")
        Map<String, Object> imagePart = (Map<String, Object>) parts.get(1);
        assertEquals("image_url", imagePart.get("type"));
        assertTrue(((Map<?, ?>) imagePart.get("image_url")).get("url").toString().startsWith("data:image/png;base64,"));
    }
    ...
    void shouldBuildConversationWithImageAndNoText() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<Map<String, Object>> conv = (List<Map<String, Object>>) method.invoke(
                client, "   ", 123L, null, "base64imagestring", "image/jpeg");
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> textPart = (Map<String, Object>) parts.get(0);
        assertEquals("[Скриншот]", textPart.get("text"));
    }
    ...
    void shouldThrowOnEmptyChoices() throws Exception {
        ...
        assertThrows(LlmProcessingException.class, () -> {
            try {
                method.invoke(client, jsonResponse);
    ...
    void shouldGetProviderName() {
        assertEquals("OpenAI", client.getClass().getSimpleName().equals("OpenAiClient") ? "OpenAI" : "");
    }
}
